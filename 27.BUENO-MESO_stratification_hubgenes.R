## ------------------------------------------------------
## Project: BUENO-MESO
## Script name: 27.BUENO-MESO_stratification_hubgenes.R
##
## Purpose of script: stratification into high and low expressors of hub genes
## 
##
...
scriptName <- "27.BUENO-MESO_stratification_hubgenes"
...
for (i in 1:nrow(overviewDF)) { 
    log <- read.table(file.path(resultsdir,
                                paste("27.BUENO-MESO_stratification_hubgenes.",
                                      overviewDF[i,1],
                                      ".log.txt",
                                      sep="")),
                      sep = "\t")
