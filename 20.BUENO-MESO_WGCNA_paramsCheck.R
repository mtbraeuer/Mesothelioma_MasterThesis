## ------------------------------------------------------
## Project: BUENO-MESO
## Script name: 20.BUENO-MESO_WGCNA_paramsCheck.R
##
## Purpose of script: params check of WGCNA
## 
##
...
scriptName <- "20.BUENO-MESO_WGCNA_paramsCheck"
...
# # exprs(EsetAnalysis) is an integer matrix, but we need a numeric matric
# DatExpr <- as.data.frame(DatExpr)
# DatExpr <- as.matrix(sapply(DatExpr, as.numeric))
# rownames(DatExpr) <- colnames(exprs(EsetAnalysis))
# str(DatExpr)
# dim(DatExpr)
